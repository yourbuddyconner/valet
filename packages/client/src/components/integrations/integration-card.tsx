...
function LinearIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className={className}>
      <path fill="#5E6AD2" d="M1.22 61.52a13.15 13.15 0 0 1-1-3.59A24.3 24.3 0 0 1 0 53.74V0l51.99 51.99H14.5a24.3 24.3 0 0 1-4.19-.23 13.15 13.15 0 0 1-3.6-1c-1.31-.63-2.47-1.48-3.43-2.51-.96-1.03-1.73-2.27-2.25-3.66a9.3 9.3 0 0 1-.47-1.73c-.12-.63-.18-1.28-.18-1.95V38.4l23.09 23.12H1.22ZM100 48.01 51.99 0H100v48.01ZM42.49 58.28 0 15.79V0l58.28 58.28H42.49ZM0 83.39 83.39 0H100L0 100V83.39Z" />
    </svg>
  );
}
