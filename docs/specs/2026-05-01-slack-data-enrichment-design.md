...
- **People:** `user_display` and `bot_display` fields identify who said what. Use `get_reactions` when you need to know who specifically agreed or acknowledged something, not just the count.
