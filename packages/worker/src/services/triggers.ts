...
export async function runWorkflowManually(
  ...
  await createExecution(env.DB, {
    ...
    triggerId: null,
    triggerType: 'manual',
    triggerMetadata: JSON.stringify({ triggeredBy: 'api', direct: true, deliveryId: clientRequestId }),
...
export async function runTrigger(
  ...
  await createExecution(env.DB, {
    ...
    triggerId,
    triggerType: 'manual',
    triggerMetadata: JSON.stringify({ triggeredBy: 'api', deliveryId: clientRequestId }),
    variables: JSON.stringify(variables),
    now,
